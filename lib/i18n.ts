...
export const LANG: Record<Lang, Translation> = {
  en: {
    ...
    groupMisc: 'Misc',
    av0Label: 'Apartment value',
    pLabel: 'Mortgage fraction',
    r0Label: 'Initial monthly rent',
    ...
    esLabel: 'Selling expenses',
    ipLabel: 'Passive return (net)',
    cgtLabel: 'Capital gains tax',
    tvatLabel: 'VAT',
    elpLabel: 'Lawyer fee (purchase)',
    elcLabel: 'Lawyer fee (partnership)',
    erebLabel: 'RE broker fee',
    ereaLabel: 'RE appraiser',
    embLabel: 'Mortgage broker',
    ...
    tooltips: {
      ...
      Es: 'Broker (~2.4%) + lawyer (~0.6%) fees at time of sale, as % of the appreciated sale price.',
  ...
  he: {
    ...
    tvatLabel: 'מע"מ',
    elpLabel: 'שכ"ט עו"ד רכישה',
    elcLabel: 'שכ"ט עו"ד שיתוף',
    erebLabel: 'עמלת מתווך',
    ereaLabel: 'שמאי מקרקעין',
    embLabel: 'יועץ משכנתא',
    g0Label: 'מכפיל יעד',
    ...
    tooltips: {
      ...
      Es: 'מתווך (~2.4%) + עו"ד (~0.6%) בעת מכירה, כאחוז משווי הדירה המוערכת.',
