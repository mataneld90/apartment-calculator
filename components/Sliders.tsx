...
const GROUPS: { getTitle: (t: Translation) => string; sliders: SliderDef[] }[] = [
  ...
  },
  {
    ...
    sliders: [
      {
        key: 'TVAT',
        getLabel: (t) => t.tvatLabel,
        getTooltip: () => '',
        min: 0.15, max: 0.2, step: 0.01,
        display: (v) => pct(v, 0),
      },
      {
        key: 'Elp',
        getLabel: (t) => t.elpLabel,
        getTooltip: () => '',
      ...
      {
        key: 'Erea',
        getLabel: (t) => t.ereaLabel,
        getTooltip: () => '',
        min: 0, max: 10_000, step: 500,
        display: (v) => shekel(v),
      },
      {
        key: 'Emb',
        getLabel: (t) => t.embLabel,
        getTooltip: () => '',
        min: 0, max: 20_000, step: 1_000,
        display: (v) => shekel(v),
      },
    ],
  },
